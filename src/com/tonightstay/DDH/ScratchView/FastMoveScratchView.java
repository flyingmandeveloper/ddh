...
public class FastMoveScratchView extends SurfaceView implements
	...
	public boolean onTouchEvent(MotionEvent me) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			{
			case VeryFast:
				mFastToSlowDuring = getWidth()
						* 2
						/ (mFastToSlowSpeedDefault + mFastToSlowSpeedStopDefault);
				mFastToSlowAcceleration = -(mFastToSlowSpeedDefault - mFastToSlowSpeedStopDefault)
						/ mFastToSlowDuring;
	...
	{
	    if (mStartBitmap1 == null || mLogo == null)
	        return;
...
//				mBgPaint);
	...
	public void onSlowToFastDraw(Canvas canvas, long offsetTime) {
	       ...
	       if (mStartBitmap1 == null || mLogo == null || mStartBitmap2== null)
	            return;
...
//				mBgPaint);
	...
	public void onSDraw(Canvas canvas, long offsetTime) {
        ...
        if (mBackgroundBitmap == null || mFinger0 == null || mFinger1 == null)
            return;
		...
		if (fingerAniIdx % 2 == 0)
		{
			canvas.drawBitmap(
					...
					new Rect(getWidth() / 2 - fingerSize / 2,
							(getHeight() * 2 / 3), getWidth() / 2 + fingerSize
									/ 2, (getHeight() * 2 / 3) + fingerSize),
					mBgPaint);
		}
		else
		{
	...
	public void onFastToSlowDraw(Canvas canvas, long offsetTime) {
	    ...
	    if (mStartBitmap3 == null || mLogo == null || mStartBitmap4 == null)
            return;
		...
		canvas.drawBitmap(
				...
				new Rect(0, 0, mStartBitmap1.getWidth(), mStartBitmap1
						.getHeight()),
				new Rect((int) mFastToSlowOffY, 0, (int) mFastToSlowOffY
						+ wholeWidth, getHeight()),
				mBgPaint);
...
//				mBgPaint);
		...
		canvas.drawBitmap(
				...
				new Rect(0, 0, mStartBitmap2.getWidth(), mStartBitmap2
						.getHeight()),
				new Rect((int) mFastToSlowOffY + wholeWidth, 0,
...
//				mBgPaint);
	...
	class FastMoveScratchViewThread extends Thread {
		...
		public FastMoveScratchViewThread(SurfaceHolder surfaceHolder,
				FastMoveScratchView view) {
