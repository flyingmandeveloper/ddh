...
public class ScratchView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    HintField mHintField1 = new HintField();
    HintField mHintField2 = new HintField();
    HintField mHintField3 = new HintField();

    PrizeField mPrize1 = new PrizeField();
    PrizeField mPrize1_1 = new PrizeField();
    ...
    public void setPrize1_1Rect(Rect rect)
    {
        mPrize1_1 = new PrizeField();
        mPrize1_1.setRect(rect);
    ...
    public void setHintField1Rect(Rect rect)
    {
        mHintField1.setRect(rect);
    }
    
    public void setHintField2Rect(Rect rect)
    {
        mHintField2.setRect(rect);
    }
    
    public void setHintField3Rect(Rect rect)
    {
        mHintField3.setRect(rect);
    }

    /*
     * public void setPrizeMessage(String prize1,String prize2,String []prize3)
     * { mPrize1.setMessage(prize1); int textSize = mPrize1.testTextSize();
     * 
     * mPrize2.setMessage(prize2); textSize =Math.min(mPrize2.testTextSize(),
     * textSize);
     * 
     * mPrize3.setMessage(prize3); textSize =Math.min(mPrize3.testTextSize(),
     * textSize);
     * 
     * mPrize1.setTextSize(textSize); mPrize2.setTextSize(textSize);
    ...
    public void setPrizeMessage(String prize1, String prize1_1, String prize2, String hint1, String hint2, String hint3, int hintFontSize)
    {
        ...
        mHintField1.setMessage(hint1);
        mHintField1.setTextSize(hintFontSize);
        mHintField2.setMessage(hint2);
        mHintField2.setTextSize(hintFontSize);
        mHintField3.setMessage(hint3);
        mHintField3.setTextSize(hintFontSize);
    }

    public void setPrizeMessage(String prize1, String prize1_1, String prize2, Bitmap[] prize3, String hint1, String hint2, String hint3, int hintFontSize)
    {
        mPrize1.setMessage(prize1);
        int textSize = mPrize1.testTextSize();
    ...
    public void setStrokeWidth(int width)
    {
        ...
        mHintField1.setStrokeWidth(width);
    ...
    public void onSDraw(Canvas canvas) {
        ...
        if (mCoverCanvas == null || mCoverBitmap == null)
            return;
        ...
        // mLogoBitmap.getWidth(), mLogoBitmap.getHeight()+mLogoOffsetY),
        // bgPaint);
        //

        mPrize1.onDrawPrize(canvas);
        if (mPrize1_1!=null)
            mPrize1_1.onDrawPrize(canvas);
        ...
        if (mShowScratchCover && mCoverBitmap != null)
    ...
    public void surfaceChanged(SurfaceHolder arg0, int arg1, int arg2, int arg3) {
        ...
        mHintField1.onDrawLine(mCoverCanvas);
        mHintField1.onDrawPrize(mCoverCanvas);

        mHintField2.onDrawLine(mCoverCanvas);
        mHintField2.onDrawPrize(mCoverCanvas);

        mHintField3.onDrawLine(mCoverCanvas);
        mHintField3.onDrawPrize(mCoverCanvas);
